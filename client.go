...
func newClient(endpoint string) (c Client, err error) {
	c.rpcclient, err = rpc.DialContext(nil, endpoint)
	if err != nil {
...
func (c *Client) ConfirmTx(ctx context.Context, hash string, confirmBlock uint64) error {
	...
	if recept.BlockNumber.Uint64()+confirmBlock > block {
